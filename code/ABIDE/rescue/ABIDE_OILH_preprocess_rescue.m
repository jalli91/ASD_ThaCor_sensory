% ABIDE_OILH_preprocess_rescue.m
%
% Rescue preprocessing script for 7 ABIDEII-OILH_2 subjects that were
% missing from the main pipeline run.
%
% Target subjects (all in ABIDEII-OILH_2):
%   ma28681, ma28682, ma28683, ma28687   (male ASD)
%   fc28711, fc28713                     (female Control)
%   mc28712                              (male Control)
%
...
%
% Output: one CONN project .mat per subject in
%         ImageFiles/ABIDEII-OILH_2/batch_output/
...
% --- Hardcoded rescue target: ABIDEII-OILH_2 only -------------------
inst_name = 'ABIDEII-OILH_2';
inst_path = fullfile(imageFilesDir, inst_name);
sp        = site_params.OILH_II;
...
% Rescue subjects — female-first ordering (fc before ma/mc)
subj_names = {'mc28723'};
